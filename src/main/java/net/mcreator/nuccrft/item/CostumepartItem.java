...
public class CostumepartItem extends NuccrftModElements.ModElement {
	@ObjectHolder("nuccrft:costumepart")
	public static final Item block = null;

	public CostumepartItem(NuccrftModElements instance) {
		super(instance, 4);
	}

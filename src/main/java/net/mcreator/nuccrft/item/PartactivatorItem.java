...
import net.mcreator.nuccrft.gui.PartactguiGuiWindow;
import net.mcreator.nuccrft.gui.PartactguiGui;
...
public class PartactivatorItem extends NuccrftModElements.ModElement {
	@ObjectHolder("nuccrft:partactivator")
	public static final Item block = null;

	public PartactivatorItem(NuccrftModElements instance) {
		super(instance, 7);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PartactguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Partactivator");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PartactguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
